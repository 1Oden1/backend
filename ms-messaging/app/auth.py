...
def require_role(*roles: str):
    """Dépendance factory : vérifie qu'au moins un des rôles est présent."""
...
require_etudiant   = require_role("etudiant", "delegue")
require_delegue    = require_role("delegue")
require_any        = require_role("admin", "enseignant", "etudiant", "delegue")
